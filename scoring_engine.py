#!/usr/bin/env python3
"""
Investment Scoring Engine - Sistema de 3 scores para análisis completo.
...
class InvestmentScorer:
    """Sistema de 3 scores para análisis completo de inversiones."""

    def __init__(self):
        # Estos pesos se usan solo para los sub-scores
